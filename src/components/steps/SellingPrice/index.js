...
const handleBack = () => {
  ...
  /* If a user goes back then we need to reset these vars to false else navigate() will be triggered straight away after render by the useEffect() on TransactionType. */
